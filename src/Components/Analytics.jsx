...
function Analytics() {
    return (
        <div class="dvh mt-8 analytics p-3 md:px-20 flex items-center gap-x-7" data-testid="analytics-component">
            <div>
                ...
                <h3 class="md:text-5xl text-3xl"><Slide>Empowers Businesses to Make Insightful Decisions</Slide></h3>
